...
**C++**
``` C++
public ref class Url : public PayloadGenerator.Payload
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_QRCoder_Core_PayloadGenerator_Payload.md">PayloadGenerator.Payload</a>  →  PayloadGenerator.Url</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_QRCoder_Core_PayloadGenerator_Url__ctor.md">PayloadGenerator.Url</a></td>
<td>Generates a link. If not given, http/https protocol will be added.</td></tr>
</table>
...
<tr>
<td><a href="M_QRCoder_Core_PayloadGenerator_Url_ToString.md">ToString</a></td>
