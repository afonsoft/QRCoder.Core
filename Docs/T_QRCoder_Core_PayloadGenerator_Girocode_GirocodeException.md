# PayloadGenerator.Girocode.GirocodeException Class


\[Missing &lt;summary&gt; documentation for "T:QRCoder.Core.PayloadGenerator.Girocode.GirocodeException"\]
...
**C++**
``` C++
public ref class GirocodeException : public Exception
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a>  →  PayloadGenerator.Girocode.GirocodeException</td></tr>
</table>
...
<td>Initializes a new instance of the PayloadGenerator.Girocode.GirocodeException class</td></tr>
<tr>
