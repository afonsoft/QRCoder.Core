...
**C++**
``` C++
public ref class QRCode : public AbstractQRCode
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_QRCoder_Core_AbstractQRCode.md">AbstractQRCode</a>  →  QRCode</td></tr>
</table>
...
<td>Initializes a new instance of the QRCode class</td></tr>
</table>
