# PayloadGenerator.ShadowSocksConfig Class


\[Missing &lt;summary&gt; documentation for "T:QRCoder.Core.PayloadGenerator.ShadowSocksConfig"\]
...
**C++**
``` C++
public ref class ShadowSocksConfig : public PayloadGenerator.Payload
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_QRCoder_Core_PayloadGenerator_Payload.md">PayloadGenerator.Payload</a>  →  PayloadGenerator.ShadowSocksConfig</td></tr>
</table>
...
<td>Initializes a new instance of the PayloadGenerator.ShadowSocksConfig class</td></tr>
<tr>
...
<tr>
<td><a href="M_QRCoder_Core_PayloadGenerator_ShadowSocksConfig_ToString.md">ToString</a></td>
