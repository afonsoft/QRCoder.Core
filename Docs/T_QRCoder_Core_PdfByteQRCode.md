...
\[Missing &lt;summary&gt; documentation for "T:QRCoder.Core.PdfByteQRCode"\]
...
**C++**
``` C++
public ref class PdfByteQRCode : public AbstractQRCode, 
	IDisposable
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_QRCoder_Core_AbstractQRCode.md">AbstractQRCode</a>  →  PdfByteQRCode</td></tr>
...
<td>Initializes a new instance of the PdfByteQRCode class</td></tr>
</table>
