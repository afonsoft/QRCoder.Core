# PayloadGenerator.ShadowSocksConfig.ShadowSocksConfigException Class


\[Missing &lt;summary&gt; documentation for "T:QRCoder.Core.PayloadGenerator.ShadowSocksConfig.ShadowSocksConfigException"\]
...
**C++**
``` C++
public ref class ShadowSocksConfigException : public Exception
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a>  →  PayloadGenerator.ShadowSocksConfig.ShadowSocksConfigException</td></tr>
</table>
...
<td>Initializes a new instance of the PayloadGenerator.ShadowSocksConfig.ShadowSocksConfigException class</td></tr>
<tr>
