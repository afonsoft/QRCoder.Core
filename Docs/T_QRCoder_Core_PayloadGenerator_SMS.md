# PayloadGenerator.SMS Class


\[Missing &lt;summary&gt; documentation for "T:QRCoder.Core.PayloadGenerator.SMS"\]
...
**C++**
``` C++
public ref class SMS : public PayloadGenerator.Payload
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_QRCoder_Core_PayloadGenerator_Payload.md">PayloadGenerator.Payload</a>  →  PayloadGenerator.SMS</td></tr>
</table>
...
<tr>
<td><a href="M_QRCoder_Core_PayloadGenerator_SMS_ToString.md">ToString</a></td>
