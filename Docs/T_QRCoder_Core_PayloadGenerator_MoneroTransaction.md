# PayloadGenerator.MoneroTransaction Class


\[Missing &lt;summary&gt; documentation for "T:QRCoder.Core.PayloadGenerator.MoneroTransaction"\]
...
**C++**
``` C++
public ref class MoneroTransaction : public PayloadGenerator.Payload
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="T_QRCoder_Core_PayloadGenerator_Payload.md">PayloadGenerator.Payload</a>  →  PayloadGenerator.MoneroTransaction</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_QRCoder_Core_PayloadGenerator_MoneroTransaction__ctor.md">PayloadGenerator.MoneroTransaction</a></td>
<td>Creates a monero transaction payload</td></tr>
</table>
...
<tr>
<td><a href="M_QRCoder_Core_PayloadGenerator_MoneroTransaction_ToString.md">ToString</a></td>
