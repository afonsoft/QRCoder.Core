# PayloadGenerator.MoneroTransaction.MoneroTransactionException Class


\[Missing &lt;summary&gt; documentation for "T:QRCoder.Core.PayloadGenerator.MoneroTransaction.MoneroTransactionException"\]
...
**C++**
``` C++
public ref class MoneroTransactionException : public Exception
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a>  →  PayloadGenerator.MoneroTransaction.MoneroTransactionException</td></tr>
</table>
...
<td>Initializes a new instance of the PayloadGenerator.MoneroTransaction.MoneroTransactionException class</td></tr>
<tr>
