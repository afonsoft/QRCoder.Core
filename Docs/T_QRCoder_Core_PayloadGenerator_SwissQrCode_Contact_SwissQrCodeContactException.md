# PayloadGenerator.SwissQrCode.Contact.SwissQrCodeContactException Class


\[Missing &lt;summary&gt; documentation for "T:QRCoder.Core.PayloadGenerator.SwissQrCode.Contact.SwissQrCodeContactException"\]
...
**C++**
``` C++
public ref class SwissQrCodeContactException : public Exception
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a>  →  PayloadGenerator.SwissQrCode.Contact.SwissQrCodeContactException</td></tr>
</table>
...
<td>Initializes a new instance of the PayloadGenerator.SwissQrCode.Contact.SwissQrCodeContactException class</td></tr>
<tr>
