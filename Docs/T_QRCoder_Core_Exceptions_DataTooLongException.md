# DataTooLongException Class


\[Missing &lt;summary&gt; documentation for "T:QRCoder.Core.Exceptions.DataTooLongException"\]
...
**C++**
``` C++
public ref class DataTooLongException : public Exception
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a>  →  DataTooLongException</td></tr>
</table>
...
<td>Initializes a new instance of the DataTooLongException class</td></tr>
<tr>
