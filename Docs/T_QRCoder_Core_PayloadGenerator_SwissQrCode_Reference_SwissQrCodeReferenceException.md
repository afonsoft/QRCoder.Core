# PayloadGenerator.SwissQrCode.Reference.SwissQrCodeReferenceException Class


\[Missing &lt;summary&gt; documentation for "T:QRCoder.Core.PayloadGenerator.SwissQrCode.Reference.SwissQrCodeReferenceException"\]
...
**C++**
``` C++
public ref class SwissQrCodeReferenceException : public Exception
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.exception" target="_blank" rel="noopener noreferrer">Exception</a>  →  PayloadGenerator.SwissQrCode.Reference.SwissQrCodeReferenceException</td></tr>
</table>
...
<td>Initializes a new instance of the PayloadGenerator.SwissQrCode.Reference.SwissQrCodeReferenceException class</td></tr>
<tr>
