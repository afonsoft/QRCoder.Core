...
**C++**
``` C++
public ref class StringValueAttribute : public Attribute
```

<table><tr><td><strong>Inheritance</strong></td><td><a href="https://learn.microsoft.com/dotnet/api/system.object" target="_blank" rel="noopener noreferrer">Object</a>  →  <a href="https://learn.microsoft.com/dotnet/api/system.attribute" target="_blank" rel="noopener noreferrer">Attribute</a>  →  StringValueAttribute</td></tr>
</table>
...
<table>
<tr>
<td><a href="M_QRCoder_Core_Extensions_StringValueAttribute__ctor.md">StringValueAttribute</a></td>
<td>Init a StringValue Attribute</td></tr>
</table>
